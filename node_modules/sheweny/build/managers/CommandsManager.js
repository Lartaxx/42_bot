...
class CommandsManager extends _1.BaseManager {
    ...
    constructor(client, options) {
        ...
        this.default = {
            ...
            type: options.default?.type || constants_1.COMMAND_TYPE.cmdMsg,
     ...
     * @returns {Promise<void>}
     */
    async registerPermissions(applicationCommands = this.client.application?.commands.cache, commandsCollection = this.commands, guildId) {
