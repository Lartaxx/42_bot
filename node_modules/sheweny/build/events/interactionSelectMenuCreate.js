    ...
    try {
        ...
        if (!client.admins?.includes(interaction.user.id)) {
            if (!client.cooldowns.selectMenus.has(selectMenu.customId)) {
                client.cooldowns.selectMenus.set(selectMenu.customId, new discord_js_1.Collection());
            }
            ...
            if (tStamps.has(interaction.user.id)) {
                ...
                if (timeNow < cdExpirationTime) {
                    ...
                    return client.managers.selectMenus?.emit(constants_1.SELECT_EVENTS.cooldownLimit, interaction, cdExpirationTime - timeNow);
                }
            }
